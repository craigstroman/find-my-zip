	      ...
	      navigator.geolocation.getCurrentPosition(function (position) {
	        ...
	        xhr.addEventListener('load', function () {
	          ...
	          function findAddressComponent(addressParts, adressPart, nameType) {
	            var index = _lodash2.default.findIndex(addressParts, function (e) {
	          ...
	          var streetNumber = findAddressComponent(addressComponents, 'street_number', 'short_name');
	          var streetName = findAddressComponent(addressComponents, 'route', 'short_name');
	          var city = findAddressComponent(addressComponents, 'locality', 'long_name');
	          var state = findAddressComponent(addressComponents, 'administrative_area_level_1', 'short_name');
	          var zipCode = findAddressComponent(addressComponents, 'postal_code', 'long_name');
	          var country = findAddressComponent(addressComponents, 'country', 'short_name');
